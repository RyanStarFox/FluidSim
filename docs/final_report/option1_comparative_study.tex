...
\begin{table}[!t]
  ...
  \begin{tabular}{lrlrr}
    ...
    \midrule
0.00 & PIC & 34.8116 & 0.0170 & 2.1\% \\
0.50 & Blend & 34.5693 & 2.2291 & 271.2\% \\
0.80 & Blend & 34.9382 & 0.0441 & 5.4\% \\
0.95 & Blend & 34.6368 & 0.1114 & 13.6\% \\
0.97 & Blend & 35.1273 & 0.2105 & 25.7\% \\
1.00 & FLIP & 35.3814 & 26.1584 & 3190.8\% \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[!t]
  ...
  \begin{tabular}{lrlrr}
    ...
    Ratio & Type & Peak E & Final E & Retention \\
    \midrule
0.00 & PIC & 2.3530 & 2.3016 & 5327.8\% \\
0.50 & Blend & 2.5209 & 2.4750 & 5729.2\% \\
0.80 & Blend & 3.7621 & 3.5654 & 8253.3\% \\
0.95 & Blend & 8.4043 & 8.4043 & 19454.4\% \\
0.97 & Blend & 8.4851 & 8.3959 & 19435.0\% \\
1.00 & FLIP & 9.4390 & 9.3570 & 21659.8\% \\
    \bottomrule
  \end{tabular}
\end{table}
